                    ...
                    <div className="Left" style={{display: "flex", flexDirection: "column", justifyContent: "center", gap: "0.8vw", width: "50%"}}>
                        <div style={{display: "flex", alignItems: "center", gap: "0.7vw", }}>
                            ...
                            <div className="detail1" style={{display: "flex", flexDirection: "column", gap: "0.5vw"}}>
                                <MyProfileP>{userData ? userData.name : "Loading..."}</MyProfileP>
                                <div style={{display: "flex", alignItems: "center", gap: "0.3vw"}}>
                                    <MyProfileP style={{fontSize: "0.75vw"}}>{userData ? userData.username : "Loading..."}</MyProfileP>
                                    <img src={Dot2} alt="dot" style={{width: "0.15vw", height: "0.15vw"}}/>
                                    <MyProfileP style={{fontSize: "0.75vw"}}>{userData ? userData.birth : "Loading..."}</MyProfileP>
                                </div>
                            </div>
                        </div>
                        <div className="detail" style={{display: "flex", flexDirection: "column", gap: "0.3vw"}}>
                            ...
                            <Box>
                                ...
                                <MyProfileP style={{fontWeight: "500", fontSize: "0.75vw", color: colors.crewGray2}}>{userData ? userData.phone : "Loading..."}</MyProfileP>
                            </Box>
                        </div>
                    </div>
